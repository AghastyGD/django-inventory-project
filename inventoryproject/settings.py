...
SECRET_KEY = 'django-insecure-y@@vxte65#)ofgpp3mveg%*e@@r*bp2oit3*4)9b8w=8*#2l13'
...
STATIC_ROOT = os.path.join(BASE_DIR, "staticfiles_build", "asert", "static")
